...
<!-- For checkpoint task examples and patterns, see @/Users/callumcowie/repos/Aether/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/callumcowie/repos/Aether/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/callumcowie/repos/Aether/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/callumcowie/repos/Aether/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
