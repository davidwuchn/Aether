...
<required_reading>
@/Users/callumcowie/repos/Aether/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/callumcowie/repos/Aether/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
